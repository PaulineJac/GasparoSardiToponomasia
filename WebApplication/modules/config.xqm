...
(:
 ...
 :)
declare variable $config:default-template :="Top_Transcription.html";
...
(:~
 ...
 :)
declare variable $config:default-odd :="Toponomasia.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("Toponomasia.odd");
